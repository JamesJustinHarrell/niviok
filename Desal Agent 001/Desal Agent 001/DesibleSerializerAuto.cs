...
abstract class DesibleSerializerAuto : DesibleSerializerBase {
	protected virtual XmlElement serialize(Node_Chain node) {
	...
	protected virtual XmlElement serialize(Node_ForPair node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
	...
	protected virtual XmlElement serialize(Node_ForRange node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<Node_Identifier>(elem, node.@name, "name");
	...
	protected virtual XmlElement serialize(Node_Possibility node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<INode_Expression>(elem, node.@test, "test");
	...
	protected virtual XmlElement serialize(Node_Block node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
	...
	protected virtual XmlElement serialize(Node_While node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<INode_Expression>(elem, node.@test, "test");
	...
	protected virtual XmlElement serialize(Node_ForKey node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<INode_Expression>(elem, node.@container, "container");
		append<INode_Expression>(elem, node.@keyInterface, "key-interface");
		append<Node_Identifier>(elem, node.@name, "name");
	...
	protected virtual XmlElement serialize(Node_Comprehension node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
	...
	protected virtual XmlElement serialize(Node_Array node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<Node_NullableType>(elem, node.@nullableType, null);
		append<INode_Expression>(elem, node.@elements, "element");
		return elem;
	...
	protected virtual XmlElement serialize(Node_ForValue node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<INode_Expression>(elem, node.@container, "container");
		append<INode_Expression>(elem, node.@valueInterface, "value-interface");
		append<Node_Identifier>(elem, node.@name, "name");
	...
	protected virtual XmlElement serialize(Node_Loop node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<Node_Block>(elem, node.@block, null);
		return elem;
	}
	...
	protected virtual XmlElement serialize(Node_ForManual node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
	...
	protected virtual XmlElement serialize(Node_DoWhile node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
		append<Node_Block>(elem, node.@action, "action");
		append<INode_Expression>(elem, node.@test, "test");
		return elem;
	...
	protected virtual XmlElement serialize(Node_DoTimes node) {
		XmlElement elem = _doc.CreateElement(node.typeName, desible1NS);
