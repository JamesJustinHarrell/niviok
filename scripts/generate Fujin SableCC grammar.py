...
inputGrammarPath = os.path.join(paths.fujinSableccDir,"Fujin sablecc grammar.txt")
outputGrammarPath = os.path.join(paths.fujinSableccDir,"Fujin.sablecc")

outputTemplate = """
//This file was created programmatically, so
//DO NOT EDIT THIS FILE DIRECTLY.

Package Acrid.Fujin.SableCC;
